...
<html>
    ...
    <body>
        <div class="container">
            <h1>Requisiciones (Alta, Baja y Modificación)</h1>
            <br>
            <br>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">FECHA DE REGISTRO y DE SOLICITUD DE ENTREGA (DD/MM/AAAA)</th>
                        <th class="text-center">NOMBRE DE OBRA</th>
                        <th class="text-center">PERSONA(S) RESPONSABLES </th>
